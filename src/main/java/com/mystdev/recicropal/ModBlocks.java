...
public class ModBlocks {
    ...
    public static final BlockEntry<? extends TrellisVineBlock> PUMPKIN_VINE =
            REGISTRATE.get()
                      ...
                      .properties((p) -> BlockBehaviour.Properties.copy(Blocks.VINE))
                      .register();    public static final BlockEntry<BottleGourdVineBlock> BOTTLE_GOURD_VINE =
            REGISTRATE.get()
    ...
    public static final BlockEntry<? extends TrellisCropBlock> PUMPKIN_CROP =
            REGISTRATE.get()
                      ...
                      .properties((p) -> BlockBehaviour.Properties.copy(Blocks.VINE))
                      .register();    public static final BlockEntry<BottleGourdCropBlock> BOTTLE_GOURD_CROP =
            REGISTRATE.get()
